...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* Hero Section with improved animations and layout */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeIn">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">The Ultimate Nigerian Gambling Experience</h1>
              <p className="text-xl mb-8 text-blue-100 max-w-lg">Play the classic stone game online with real stakes and instant payouts. Join thousands of players today!</p>
              <div className="flex flex-wrap gap-4">
                <Button 
                  onClick={handleSignIn}
                  size="lg"
                  className="bg-secondary hover:bg-yellow-500 text-primary font-bold shadow-lg transform transition-all hover:translate-y-[-2px]"
                >
                  Sign In / Register <ChevronRight className="ml-1 h-5 w-5" />
                </Button>
                <Button 
                  onClick={handleQuickDemo}
                  size="lg" 
            ...
            <div className="flex justify-center">
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 shadow-2xl">
                <div className="grid grid-cols-3 gap-3">
                  {/* Game stones examples with better visual hierarchy */}
                  {[29, 75, 42, 1000, 3355, 63, 500, 6624, 91].map((number, index) => (
                    <div 
                      key={index}
                      className={`w-16 h-16 md:w-20 md:h-20 rounded-lg flex items-center justify-center font-bold text-lg md:text-xl shadow-lg transform transition-all duration-300 ${
                        number === 1000 || number === 500 
                          ? 'bg-yellow-500 text-primary hover:bg-yellow-400 hover:scale-105' 
                          : number === 3355 || number === 6624 
                            ? 'bg-red-600 text-white border-2 border-yellow-400 hover:bg-red-500 hover:scale-105' 
